...
const CropRotation = (props) => {
    ...
    return (
        <div className="CropRotation">
            ...
            <strong><p>Recommended Rotations</p></strong>
            <div className="resize">
                <Plot 
                    type={"crop"} 
                    image={currentData.currentCrop.image} 
                    state={currentData.currentCrop.state} 
                    name={currentData.currentCrop.name} 
                    earthScore={currentData.currentCrop.earthScore} 
                />
            </div>
            ...
            <div className="resize">
                <Plot 
                    type={"crop"} 
                    state={currentData.newCrop.state} 
                    image={currentData.newCrop.image} 
                    ame={currentData.newCrop.name} 
                    earthScore={currentData.newCrop.earthScore} 
                />
            </div>
